...
\begin{align*}
	\frac{dV}{dt} =& f(V) + l(t) \text{, what if we try a linear $f$}\\
	=&-a(V-V_0) + l(t)
\end{align*}
...
\begin{figure}[H]
	\caption[Exponential integrate and fire ]{Exponential integrate and fire: $f(V)=-a(V-V_0) + \exp\big[\frac{V-V_{th}}{\Delta}\big]$}
	\includegraphics[width=0.9\textwidth]{exponential-integrate-and-fire}
\end{figure}

\begin{figure}[H]
	\caption[The $\theta$ neuron]{The $\theta$ neuron: $\frac{d\theta}{dt}=1-\cos\theta + (1+\cos\theta)l(t)$}
	\includegraphics[width=0.9\textwidth]{theta-neuron}
\end{figure}

\begin{figure}[H]
	\caption[An additional fixed point]{An additional fixed point}
	\includegraphics[width=0.9\textwidth]{3fp}
\end{figure}

\begin{figure}[H]
	\caption[A 2d model]{A 2d model}
	\includegraphics[width=0.9\textwidth]{2d}
\end{figure}

\begin{figure}[H]
	\caption[A 2d spiking  model]{A 2d spiking model}
...
\begin{figure}[H]
	\caption[simple-model]{simple-model}
	\begin{subfigure}[b]{0.45\textwidth}
