...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\caption{Exponential function gives a reasonable fit for some synapses, e.g. AMPA, $GABA_A$}
	...
	\end{subfigure}
	\begin{subfigure}[t]{0.9\textwidth}
		\caption{Others can be fit using Alpha function: $\alpha(t)=\frac{t}{\tau_{peak}} exp\big(1-\frac{t}{\tau_{peak}}\big)$}
