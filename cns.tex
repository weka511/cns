...
\begin{figure}[H]
	\begin{center}
		\caption[Sparse Coding Network is a special case of Predictive Coding Networks]{Sparse Coding Network is a special case of Predictive Coding Networks. The recurrent weights allow for time dependent input, and the sensory error gain allows for attention\cite{rao1999optimal,rao1999predictive}.}
