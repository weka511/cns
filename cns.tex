...
\begin{align*}
	...
	\tau_m =& r_m c_m \text{, and}\\
	\lambda =& \sqrt{\frac{r_m}{r_i}}
\end{align*}


\begin{figure}[H]
	\caption[potential-decay-space?]{potential-decay-space?}
	\includegraphics[width=0.8\textwidth]{potential-decay-space}
\end{figure}


\begin{figure}[H]
	\caption[voltage-decay-space-time]{voltage-decay-space-time}
	\includegraphics[width=0.8\textwidth]{voltage-decay-space-time}
\end{figure}


\begin{figure}[H]
	\caption[general-solution]{general-solution}
	\includegraphics[width=0.8\textwidth]{general-solution}
\end{figure}
