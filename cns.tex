...
\begin{figure}[H]
	\caption[What makes a neuron compute?]{What makes a neuron compute? So far everything we have seen is linear. The figure shows that most curves are just expandd or contracted versions of each other. But sometimes something else is happening...Excitability}
